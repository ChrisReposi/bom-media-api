...
export class UploadVideoDto {
  ...
  @ApiProperty({ example: "Uploaded demo video", maxLength: 200 })
  @IsString()
  @MaxLength(200)
  ...
  @ApiPropertyOptional({ example: "uploaded-demo-video", maxLength: 160 })
  @IsOptional()
  @IsString()
  @MaxLength(160)
  slug?: string;
  ...
  @ApiPropertyOptional({
    example: "training,internal",
    description: "Comma-separated Cloudinary tags.",
  })
  @IsOptional()
  @IsString()
  @MaxLength(1000)
